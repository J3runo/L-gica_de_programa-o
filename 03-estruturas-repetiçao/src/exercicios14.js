...
if(opçãojogo === 0){
    numeroMagico = leia.questionInt("Digite o numero magico ",{hideEchoBack: true   })  //hideEchoBack: true esconde o numero com *

}else if(opçãojogo === 1){
    var dificudade = leia.keyInSelect(["FACIL","MEDIO","DIFICIL","SUPER DIFICIL"])
    switch(dificudade){
        case 0:       //facil
